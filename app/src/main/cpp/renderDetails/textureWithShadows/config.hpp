 ...
 *
 */
#ifndef AMAZING_LABYRINTH_TEXTUREWITHSHADOWS_CONFIG_HPP
#define AMAZING_LABYRINTH_TEXTUREWITHSHADOWS_CONFIG_HPP
...
#endif // AMAZING_LABYRINTH_TEXTUREWITHSHADOWS_CONFIG_HPP