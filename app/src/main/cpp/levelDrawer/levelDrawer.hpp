...
public:
    ...
    virtual size_t addObjectsDataForObject(size_t objsIndex, glm::mat4 const &modelMatrix) = 0;

    virtual void resizeObjectsData(size_t objsIndex, size_t newSize) = 0;

    virtual size_t numberObjectsDataForObject(size_t objsIndex) = 0;
