...
namespace renderDetails {
    ...
    class CommonObjectDataVulkan;
    class DrawObjectDataVulkan;
}

namespace levelDrawer {
    struct DrawObjectGLTraits {
        using RenderDetailsReferenceType = renderDetails::RenderDetailsReference<renderDetails::RenderDetailsVulkan, renderDetails::CommonObjectDataVulkan>;
