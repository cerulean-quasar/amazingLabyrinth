...
namespace levelDrawer {
    template <> bool LevelDrawerGraphics<LevelDrawerVulkanTraits>::invertY() { return true; }
    template <> bool LevelDrawerGraphics<LevelDrawerVulkanTraits>::depth0to1() { return true; }
